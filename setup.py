...
setuptools.setup(
    ...
    name='fzf-ueberzogen',  # Required
    license='GPLv3',
    scripts=[
        'fzf-ueberzogen/fzf-ueberzogen.sh',
    ],
    ...
    description='Just a script which allows to use fzf with ueberzug',  # Required
    ...
    keywords='image media terminal ui fzf',  # Optional
    ...
    install_requires=['ueberzug'],  # Optional
    python_requires='>=3.5',
